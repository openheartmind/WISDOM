...
This document is intended to collect written content created for the WISDOM project. Anything can be recorded here, for example conference proposals, pitches, website text, grant applications etc. (personal introductions and requests for support should go [here](admin/introductions.md) instead). Place newer contributions at the top, using two hashes to create a new title (## Example title), and three or four hashes to create subheadings if required (### Example subheading). You can link websites by selecting the relevant text and pasting.
